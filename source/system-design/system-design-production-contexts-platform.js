...
const contexts={
  ...
  'streaming-real-time-processing::Tumbling windows':{
    ...
    components:[
      ...
      ['tumblingWindow','Revenue Window Operator','groups events into non-overlapping minute buckets per campaign','worker',56,22],
  ...
  'streaming-real-time-processing::Sliding windows':{
    ...
    components:[
      ...
      ['slidingWindow','Rolling Feature Operator','maintains rolling spend and decline features per card','worker',56,22],
  ...
  'streaming-real-time-processing::Session windows':{
    ...
    components:[
      ...
      ['sessionWindow','Sessionization Operator','groups activity into user sessions based on inactivity gaps','worker',56,22],
